...
- dialog:
  - button "×"
  - heading " Nuevo cliente" [level=4]
  - strong: " Hubo problemas con los siguientes campos:"
  - list:
    - listitem: Debe ingresar ciudad
    - listitem: Debe ingresar comuna
    - listitem: debe ser un rut válido
  - text: Tipo *
  - radio "Empresa" [checked]
  - text: Empresa
  - radio "Persona"
  - text: Persona
  - link "Logo e rut Escanear QR E-RUT":
    - /url: "#"
    - img "Logo e rut"
    - text: Escanear QR E-RUT
  - text: RUT *
  - textbox: 12.345.678-9
  - text: RUT inválido
  - checkbox "Sin RUT"
  - text: Sin RUT Nombre/Razón social *
  - textbox
  ...
  - combobox:
    - listbox:
      - option "Seleccione..." [selected]
  - text: Correo(s) electrónico(s) 
  - textbox
  - text: Teléfono responsable
  - textbox
